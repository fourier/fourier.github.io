...
6. [Finnapl - support for FinnAPL idioms list](#finnapl)
...
- [documentation update](http://lists.gnu.org/archive/html/bug-apl/2017-04/msg00009.html) converted documentation from the [GNU APL Emacs mode](https://github.com/lokedhs/gnu-apl-mode)(by Elias Mårtenson) to the format which could be used by GNU APL.
...
For Dvorak layout with Macbook's keyboard I've designed the following corresponding APL layout (without and with the Shift key):
